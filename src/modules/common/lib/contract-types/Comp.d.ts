...
export class Comp extends Contract {
  ...
  functions: {
    ...
    delegate(delegatee: string, overrides?: Overrides): Promise<ContractTransaction>;

    'delegate(address)'(delegatee: string, overrides?: Overrides): Promise<ContractTransaction>;
    ...
    'delegates(address)'(arg0: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    'numCheckpoints(address)'(arg0: string, overrides?: CallOverrides): Promise<[number]>;
  ...
  filters: {
    Approval(owner: string | null, spender: string | null, amount: null): EventFilter;
  ...
  estimateGas: {
    ...
    approve(spender: string, rawAmount: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
    ...
    'delegate(address)'(delegatee: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    'delegates(address)'(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    'numCheckpoints(address)'(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    transfer(dst: string, rawAmount: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    delegate(delegatee: string, overrides?: Overrides): Promise<PopulatedTransaction>;

    'delegate(address)'(delegatee: string, overrides?: Overrides): Promise<PopulatedTransaction>;
    ...
    'delegates(address)'(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
